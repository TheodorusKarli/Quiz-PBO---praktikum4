...
public class QuizPraktikum {
   ...
   public static void main (String args[]){
	 ...
	 System.out.println(); 
		...
		System.out.println("G (Huruf Besar) ");
		System.out.println("O (Huruf Besar) ");
		...
		if (merek == 'G') {
			...
			tipe = input.next().charAt(0); 
				...
				{System.out.print("Kode Tipe Yang Anda Masukkan Salah");
				}
		} else
		...
		{ System.out.print("Merek Yang Anda Masukkan Salah");
		}
